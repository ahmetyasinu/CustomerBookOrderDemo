package com.ahmetyasin.demogetir.config;

import com.ahmetyasin.demogetir.auth.JwtTokenFilter;
import com.ahmetyasin.demogetir.auth.UserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and().authorizeRequests().antMatchers("/swagger-ui/index.html").permitAll()
